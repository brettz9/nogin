 ...
 */
declare const layoutAndTitleGetter: (config: import('./app.js').RouteConfig, jml: typeof import('jamilih').jml) => LayoutAndTitleGetter;
/**
 * @param {RouteGetter} getRoutes
 * @param {string} localesBasePath
 * @returns {Promise<void>}
 */
declare const checkLocaleRoutes: (getRoutes: RouteGetter, localesBasePath: string) => Promise<void>;
 ...
 * @returns {RouteGetter}
 */
declare function routeGetter(customRoute: string[]): RouteGetter;
