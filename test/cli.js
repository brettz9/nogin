...
describe('CLI', function () {
  describe('Configs', function () {
    ...
    // Todo: Figure out why timing out
      ...
      async function () {
          ...
          cliProm = spawnPromise(cliPath, [
            ...
            try {
              const [
                ...
                fetch(`http://127.0.0.1:${testPort}/addUsers.json`),
                // Based on `router`
                ...
                fetch(`http://127.0.0.1:${testPort}/users`),
                // Check static coverage
                fetch(`http://127.0.0.1:${testPort}/coverage`),
        ...
        expect(headPreScripts).to.match(new RegExp(
          ...
          escStringRegex(
            ...
            '/dist/umd/popper.min.js" crossorigin="anonymous" defer="">' +
              '</script>'
          ) +
          escStringRegex(
